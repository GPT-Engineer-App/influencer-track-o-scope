...
**Project**: influencer-track-o-scope 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build me a dashboard to track influencers 
...
```sh
git clone https://github.com/GPT-Engineer-App/influencer-track-o-scope.git
cd influencer-track-o-scope
npm i
